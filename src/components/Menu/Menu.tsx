...
import { FaUserCog, FaBoxOpen, FaEnvelope, FaCreditCard, FaKey, FaTags, FaShoppingCart, FaChartLine, FaMoneyBillWave, FaWallet } from 'react-icons/fa';
    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-teal-100 to-green-100 animate-fade-in">
      ...
      <main className="flex-grow flex items-center justify-center p-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          >
            <FaEnvelope className="text-pink-700 text-5xl mb-3" />
            <h3 className="text-lg font-bold mb-1 text-pink-700">Emails</h3>
            <p className="text-gray-700 text-sm">Envía y gestiona los correos electrónicos de clientes y usuarios.</p>
          </div>
        </div>
      </main>
